...
struct NativeScrollGestureViewInner: ViewModifier {
    ...
    func body(content: Content) -> some View {
        ...
        logInView("NativeScrollGestureViewInner: body")
...
//                log("NativeScrollGestureViewInner: onScrollGeometryChange: newValue \(newValue) for layerViewModel.id \(layerViewModel.id)")
            ...
            .onChange(of: layerViewModel.interactiveLayer.nativeScrollState.jumpToX) { _, newValue in
                log(".onChange(of: nativeScrollState.jumpToX)")
            ...
            .onChange(of: layerViewModel.interactiveLayer.nativeScrollState.jumpToY) { _, newValue in
                log(".onChange(of: nativeScrollState.jumpToY)")
            ...
            .onChange(of: layerViewModel.interactiveLayer.nativeScrollState.graphReset) { _, newValue in
                log(".onChange(of: nativeScrollState.graphReset)")
                if newValue {
        ...
        // This is constantly triggering a re-render of the view,
        // which makes us listen for interactiveLayer changes

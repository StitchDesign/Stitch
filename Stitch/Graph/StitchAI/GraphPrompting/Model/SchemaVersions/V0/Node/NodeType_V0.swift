...
//            return x
    ...
    func coerceToPortValueForStitchAI(from anyValue: Any) throws -> StitchAIPortValue_V0.PortValue {
        ...
        case .number:
            ...
            return .number(x)
        case .layerDimension:
            guard let x = anyValue as? StitchAISizeDimension_V0.StitchAISizeDimension else {
                throw StitchAIParsingError.typeCasting
            }
        ...
        case .size:
            guard let aiSize = anyValue as? StitchAISize_V0.StitchAISize else {
                throw StitchAIParsingError.typeCasting
            }
            
            let size = StitchAIPortValue_V0
...
//                   (xString == "None" || xString == "\"None\"") {
        ...
        case .textDecoration:
            guard let x = anyValue as? StitchAIPortValue_V0.TextDecoration else {
                throw StitchAIParsingError.typeCasting
            }

//
//  StitchAISizeDimension_V1.swift
//  Stitch
//
...
extension StitchAISizeDimension_V1.StitchAISizeDimension: StitchVersionedCodable {
    // TODO: create migration for v1
    public init(previousInstance: StitchAISizeDimension_V1.StitchAISizeDimension) {
        fatalError()
    }
}

extension StitchAISizeDimension_V1.LayerDimension: StitchAIValueStringConvertable {
    var encodableString: String {
        self.description
    }

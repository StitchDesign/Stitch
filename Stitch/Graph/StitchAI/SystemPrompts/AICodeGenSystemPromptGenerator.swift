...
SwiftUI's `.position` view modifier places the center of a view using the parent's TOP LEFT CORNER as 0,0.
SwiftUI's `.offset` view modifier places the center of a view using the parent's CENTER 0,0.

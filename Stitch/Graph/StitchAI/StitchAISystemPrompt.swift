...
- Every action and field must match the schema and enumerations exactly.
    ...
    20. When making a node that can be dragged around, be sure to connect the output of the drag node to the position input of the node you want to drag around.

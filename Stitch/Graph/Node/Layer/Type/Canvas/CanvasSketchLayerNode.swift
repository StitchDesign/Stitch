...
struct CanvasSketchLayerNode: LayerNodeDefinition {
    ...
    static func content(document: StitchDocumentViewModel,
        ...
        PreviewCanvasSketchView(document: document,
                         graph: graph,
                         layerViewModel: viewModel,
                         isPinnedViewRendering: isPinnedViewRendering,
                         interactiveLayer: viewModel.interactiveLayer,
                         lineColor: viewModel.canvasLineColor.getColor ?? CanvasSketchLayerNodeHelpers.defaultLineColor,
                         lineWidth: viewModel.canvasLineWidth.getNumber ?? CanvasSketchLayerNodeHelpers.defaultLineWidth,
